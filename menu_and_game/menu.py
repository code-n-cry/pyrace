...
class Menu:
    def __init__(self, user_login):
        ...
        if user_login not in logins:
            cur.execute('INSERT INTO info VALUES(?, ?)', (user_login, '#0000_01_001'))
            self.con.commit()
        else:
            data = cur.execute('SELECT data FROM info where login=?', (user_login, )).fetchone()[0]
        ...
        self.music = pygame.mixer.Sound(path + '\\menu_data\\menu_music.wav')
        self.car = Car()
    ...
    def render_text(self):
        ...
        text_object_1 = font.render(f'Ваши монеты: {self.coins}', True, (255, 255, 255))
        text_object_2 = font.render(f'Машин у вас: {self.cars}', True, (255, 255, 255))
        screen.blit(text_object_1, (100, 400))
        screen.blit(text_object_2, (100, 500))
