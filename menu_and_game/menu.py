...
class Menu:
    """Главное меню. Позволяет просмотреть рекорды, перейти в магазин, гараж, выйти из игры,
    а также запустить непосредственно саму игру. Также, отвечает за рендер надписи 'GAME OVER' """
